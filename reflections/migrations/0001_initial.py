    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='reflections.User')),
            ],
        ),
        migrations.CreateModel(
            name='Reflection',
            fields=[
                ...
                ('sharedWith', models.ManyToManyField(blank=True, related_name='sharedWith', to='reflections.User')),
            ],
        ),
    ]
